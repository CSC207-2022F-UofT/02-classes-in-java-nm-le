...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes two String as arguments
     * @param s1 the first part of this Silly instance's name
     * @param s2 the second part of this Silly instance's name
     */
